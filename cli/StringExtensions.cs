...
public static class StringExtensions
{
    ...
    public static (string Left, string Right) SplitInTwo(this string s, char separator)
    {
        ...
        if (parts.Length != 2) throw new Exception($"Expected 2 parts, got {parts.Length}");
    ...
    public static (string Left, string? Right) SplitInTwoRightOptional(this string s, char separator)
    {
        var parts = s.Split(separator);
